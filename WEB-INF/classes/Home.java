...
public class Home extends HttpServlet {
  public void doGet(HttpServletRequest request,
	...
	out.println("  <form name='autofillform' action='autocomplete'>");
      ...
      out.println("  <tbody> ");
        ...
        out.println("</tr>");
          out.println("<tr>");
             out.println("<td id='auto-row' style='padding:0px;'>");
                out.println("<table id='complete-table' class='popupBox' border='0'/>");
              out.println("</td>");
          out.println("</tr>");
        out.println("</tbody>");
     out.println(" </table>");
  out.println("  </form>");
	...
	out.println("<p>Best Deal offers variety of Electronic Devices</p>");
	...
	//Trending tab is added in sidebar
	out.println("<li>");
 ...
 public void doPost(HttpServletRequest request,
  ...
  out.println("  </form>");
	...
	//Trending tab is added to sidebar
	out.println("<li>");
	out.println("<a href='trendingproducts'><h4>Trending Products</h4></a>");
	out.println("</li>");
