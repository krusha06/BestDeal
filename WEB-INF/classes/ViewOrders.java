	...
	public void doGet(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException 
{
	...
	out.println("<li class='selected' ><a href='vieworders'>View Orders</a></li>");
	...
	else
	{
		...
		/* FileInputStream fis = new FileInputStream("C:\\apache-tomcat-7.0.34\\webapps\\Assignment_1\\OrderDetails.txt");
