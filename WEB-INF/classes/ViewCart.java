...
public class ViewCart extends HttpServlet {
  public void doGet(HttpServletRequest request,
	...
	out.println("<title>Best Deal</title>");
	...
	out.println("<nav>");
	out.println("<ul>");
	out.println("<li  class='selected'><a href='home'>Home</a></li>");
				...
				for(Map.Entry<String, String> m : itemRecMap.entrySet()){
					String fileUserName = m.getKey();
						if(userid.equals(fileUserName))
						{
							...
							//out.println("<span>Recommended Products</span>");
							...
							{
								Products p = prodRecUtil.getProductByName(s.trim().replaceAll("\'",""));
								//out.println(p);
				...
				for(Map.Entry<String, String> m : itemRecMap.entrySet()){
					...
					if(userid.equals(fileUserName))
					{
						...
						for(String product : itemsList)
						{
							...
							Hashmap<String,List<Products>> productsList = prodRecUtil.getProductList();
							//Products List<Products> = prodRecUtil.getProductList(product.trim());
							...
							System.out.println(productsList.getImage());
							out.println("<table style='color:black;'>");
							out.println("<tr><td align='center'><img class=\"img-responsive\" style='width:200px;height:300px;' src=\"images\\"+productsList.getImage()+"\"></td></tr>");
							out.println("<tr><td align='center'>Name : "+productsList.getName()+"</td></tr>");
							out.println("<tr><td align='center'>Condition : "+productsList.getCondition()+"</td></tr>");
							out.println("<tr><td align='center'>Price : $"+productsList.getPrice()+"</td></tr>");
							if(fname != null && !(fname.isEmpty()))
							{	
								out.println("<form method = 'get' action = 'AddCartPage'>");
								//out.println("<input type='hidden' name='pId' value='"+item.getId()+"'>");
								out.println("<input type='hidden' name='pCategory' value='"+productsList.getCategory()+"'>");
