...
public class SoundSystems extends HttpServlet 
{
  ...
  {  
	...
	List<Products> soundSystemsList = fetchProductList.getsoundSystemsList();
	...
	out.println("<li class='selected'><a href='soundsystems'>Sound Systems</a></li>");	
	...
	out.println("<article>");
	out.println("<h2>Sound Systems</h2>" +
				"<table>");
	
	Products p,p2;
	 for(int i = 0;i<soundSystemsList.size();i++)
	{
		p = soundSystemsList.get(i);
		...
		out.println("<tr>"+
					...
					"<input type='hidden' name='product' value='"+p+"'>" +
					"<input type='hidden' name='productCategory' value='SoundSystems'>" +
					"</form>" +
