...
{	
  ...
  {	
	...
	if(userCount==0)
	{
		fos = new FileOutputStream(new File("C:\\apache-tomcat-7.0.34\\webapps\\Assignment_1\\UserDetails.txt"));
	...
	{
		fos = new FileOutputStream(new File("C:\\apache-tomcat-7.0.34\\webapps\\Assignment_1\\UserDetails.txt"),true);
