...
public class TV extends HttpServlet 
{
  ...
  {  
	...
	List<Products> tvList = fetchProductList.gettvList();
	...
	out.println("<li class='selected'><a href='tv'>TV</a></li>");	
	...
	if(tvList!=null){
		for(int i = 0;i<tvList.size();i++)
		{
			...
			out.println("<tr>"+
						...
						"<input type='hidden' name='product' value='"+p+"'>" +
						"<input type='hidden' name='productCategory' value='TV'>" +
						"</form>" +
