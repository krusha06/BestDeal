	...
	public void doGet(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException 
{
	...
	fos = new FileOutputStream(new File("C:\\tomcat\\tomcat-7.0.34-preconfigured\\apache-tomcat-7.0.34\\webapps\\Assignment_4\\OrderDetails.txt"));
	...
	{	
		out.println("<h3><br><br>The order has been shipped for delivery. Sorry, We will not be able to process your request for cancellation!!<br><br><h3>");
	}
